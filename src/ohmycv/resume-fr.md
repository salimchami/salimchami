...
[~P3]: **Audit applicatif: Comment le réaliser quelque soit le contexte !**
...
- Refonte partielle du système de contractualisation BtoB d'EDF en collaboration avec les équipes métiers et de développement. Le nouveau système devait permettre de doubler le nombre de type de contrats traités ;
...
- Développement de multiples applications:
  * Gestion de locations internes d'EDF
  * Refonte de l'application de contrôle de gestion des ressources humaines
  * Refonte du SI de la recherche et développement d'EDF   
